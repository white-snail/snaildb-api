...
create table snail_family (
	...
	name varchar(255) NOT NULL,
	FOREIGN KEY(superfamily_id) REFERENCES snail_superfamily(superfamily_id)
);
...
create table snail_genus (
	...
	name varchar(255) NOT NULL,
	FOREIGN KEY(family_id) REFERENCES snail_family(family_id)
);
...
create table snail_species (
	...
	name varchar(255) NOT NULL,
	FOREIGN KEY(genus_id) REFERENCES snail_genus(genus_id)
);
...
create table snail_subspecies (
	...
	name varchar(255) NOT NULL,
	FOREIGN KEY(species_id) REFERENCES snail_species(species_id)
);
